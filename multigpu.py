...
class Trainer:
    ...
    def _save_checkpoint(self, epoch):
        # must unwrap the model from DDP before saving
    ...
    def train(self, max_epochs: int):
        for epoch in range(max_epochs):
            ...
            # ensure only one process saves the checkpoint
...
def prepare_dataloader(dataset: Dataset, batch_size: int):
    return DataLoader(
        ...
        pin_memory=True,
        # don't shuffle the data - DistributedSampler will handle this
        shuffle=False,
        # use DistributedSampler to ensure each process gets a different subset of the dataset
...
def main(
    ...
    """Note that we don't pass the rank to this function. It's set by the spawn function."""
